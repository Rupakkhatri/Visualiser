...
export function SideNav({ state, dispatch }: SideNavProps): JSX.Element {
  return (
    <div className="absolute top-0 left-0 bottom-0 w5 z-1 shadow-1 bg-white flex flex-column">
      <div style={{ left: '16rem', background:'lightBlue', }} className="h3 fw7 f5 flex items-center pl3 bb b--light-gray">
        Live Music
      </div>
      <div className="flex-auto" style={{ left: '16rem', background:'lightBlue', }}>
